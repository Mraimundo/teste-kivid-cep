...
export function App() {
  return (
    <>
      <Header />
      <main className="w-full max-w-screen-xl h-screen flex items-center justify-center flex-col mx-auto ">
        ...
        <div className="flex flex-col p-10 space-y-8 bg-app_gray_900">
